...
const_iv(CONTEXT_D3D9_DEVICE_INTEL)
const_iv(MEM_D3D9_RESOURCE_INTEL)
const_iv(IMAGE_D3D9_FACE_INTEL)
const_iv(IMAGE_D3D9_LEVEL_INTEL)
const_iv(COMMAND_ACQUIRE_D3D9_OBJECTS_INTEL)
const_iv(COMMAND_RELEASE_D3D9_OBJECTS_INTEL)
const_iv(INVALID_D3D9_DEVICE_INTEL)
const_iv(INVALID_D3D9_RESOURCE_INTEL)
const_iv(D3D9_RESOURCE_ALREADY_ACQUIRED_INTEL)
const_iv(D3D9_RESOURCE_NOT_ACQUIRED_INTEL)
const_iv(D3D9_OBJECT_VERTEX_BUFFER)
const_iv(D3D9_OBJECT_INDEX_BUFFER)
const_iv(D3D9_OBJECT_SURFACE)
const_iv(D3D9_OBJECT_TEXTURE)
const_iv(D3D9_OBJECT_CUBE_TEXTURE)
const_iv(D3D9_OBJECT_VOLUME_TEXTURE)
